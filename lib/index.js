...
(function() {
  var Coffee, async, basename, coffee, join,
        ...
        Middleware.prototype.convert = function(options, files, source, done) {
          ...
          try {
            ...
            if (options.sourceMap) {
              outputMap = basename((options.output || this.output)(source) + '.map');
            }
            if (options.sourceMap) {
              options.generatedFile = basename(outputFile);
            }
            if (options.sourceMap) {
              options.sourceFiles = [basename(outputFile)];
            }
        ...
        Middleware.prototype.plugin = function(files, metalsmith, done) {
          ...
          return async.each(paths, this.convert.bind(null, this.options, files), (function(_this) {
            return function(err) {
              ...
              if (!_this.options.preserveSources || _this.options.sourceMap) {
